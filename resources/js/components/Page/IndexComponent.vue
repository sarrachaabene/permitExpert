          ...
          <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
              <div class="carousel-inner">
                  <div class="carousel-item active">
                      <img class="w-100" src="../../../../public/assets/images/backgrounds/carousel-1 .jpg" alt="Image">
                  ...
                  <div class="carousel-item">
                      <img class="w-100" src="../../../../public/assets/images/backgrounds/carousel-2.jpg" alt="Image">
                      <div class="carousel-caption">
                          <div class="container">
                              <div class="row justify-content-center">
                                  <div class="col-lg-7">
...
.carousel-caption[data-v-7f05eff8] {
    position: absolute;
    bottom: 1.25rem;
    padding-top: 1.25rem;
...
feuille de style user-agent a:-webkit-any-link {
  color: -webkit-link;
  cursor: pointer;
  text-decoration: underline;
}
...
feuille de style user-agent input[type="text" i] {
  padding-block: 1px;
  padding-inline: 2px;
}

feuille de style user-agent input:not([type="file" i], [type="image" i], [type="checkbox" i], [type="radio" i]) {}

feuille de style user-agent input {
  text-rendering: auto;
  color: fieldtext;
  letter-spacing: normal;
  word-spacing: normal;
...
feuille de style user-agent h6 {
  display: block;
  font-size: 0.67em;
...
feuille de style user-agent h4 {
  display: block;
...
feuille de style user-agent h2 {
  font-size: 1.5em;
  font-weight: bold;
}
