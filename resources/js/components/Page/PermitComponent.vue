...
<head>
    <meta charset="utf-8">
    <title>PermitExpert - Driving School Website Template</title>
        ...
        <div class="row gx-0 d-none d-lg-flex">
            <div class="col-lg-7 px-5 text-start">
                <div class="h-100 d-inline-flex align-items-center me-4">
                    ...
                    <small>RUE MOHAMED SHIM RBAT MONASTIR-5000 TUNISIE
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        <a href="index.html" class="navbar-brand d-flex align-items-center border-end px-4 px-lg-5">
            <h2 class="m-0"><i class="fa fa-car text-primary me-2"></i>PermitExpert</h2>
        </a>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                  <h1><img  class="viba"  ></h1>
                    <div class="position-relative overflow-hidden ps-5 pt-5 h-100" style="min-height: 400px;">
                        <img class="position-absolute w-100 h-100" src="../../../../public/assets/images/backgrounds/about-1.jpg" alt="" style="object-fit: cover;">
                        <img class="position-absolute top-0 start-0 bg-white pe-3 pb-3" src="../../../../public/assets/images/backgrounds/position.jpg" alt="" style="width: 200px; height: 200px;">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        <h6 class="text-primary text-uppercase mb-2">À PROPOS DE NOUS</h6>
                        <h1 class="display-6 mb-4">PermitExpert!Outil de gestion pour Auto-école.</h1>
                        <p>Notre mission est de fournir aux auto-écoles une solution innovante et complète pour gérer tous les aspects de leur fonctionnement. Nous proposons une plateforme intuitive qui facilite la gestion des candidats, des moniteurs, des secrétaires et des véhicules. En centralisant toutes ces informations, notre site permet aux auto-écoles d'optimiser leur organisation, de gagner du temps.</p>
                        <p class="mb-4"></p>
    ...
    <div class="container-xxl py-6">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="display-6 mb-4">PermitExpert : Des fonctionnalités conçues pour vous.
            ...
            <div class="row g-0 team-items">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item position-relative">
                        <div class="position-relative">
                            <img class="img-fluid" src="../../../../public/assets/images/backgrounds/user.jpg" alt="">
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="mt-2">Gestion des candidats
  </h5>
                            <span>Trainer</span>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item position-relative">
                        <div class="position-relative">
                            <img class="img-fluid   fas fa-user-plus fa-4x" src="../../../../public/assets/images/backgrounds/voiture.jpg" alt="">
                            <div class="team-social text-center">
                                <a class="btn btn-square btn-outline-primary border-2 m-1" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square btn-outline-primary border-2 m-1" href=""><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square btn-outline-primary border-2 m-1" href=""><i class="fab fa-instagram"></i></a>
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="mt-2">Gestion des véhicules
  </h5>
                            <span>Trainer</span>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item position-relative">
                        <div class="position-relative">
                            <img class="img-fluid" src="../../../../public/assets/images/backgrounds/transaction.jpg" alt="">
                            <div class="team-social text-center">
                                <a class="btn btn-square btn-outline-primary border-2 m-1" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square btn-outline-primary border-2 m-1" href=""><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square btn-outline-primary border-2 m-1" href=""><i class="fab fa-instagram"></i></a>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item position-relative">
                        <div class="position-relative">
                            <img class="img-fluid" src="../../../../public/assets/images/backgrounds/about-1.jpg" alt="">
                            <div class="team-social text-center">
                                <a class="btn btn-square btn-outline-primary border-2 m-1" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square btn-outline-primary border-2 m-1" href=""><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square btn-outline-primary border-2 m-1" href=""><i class="fab fa-instagram"></i></a>
...
.page-header {
    background: linear-gradient(rgba(0, 0, 0, .75), rgba(0, 0, 0, .75)), url(../../../../public/assets/images/logos/carousel-1.jpg) center center no-repeat;
 ...
 */}
/* .biba{
  background: linear-gradient(rgba(0, 0, 0, .75), rgba(0, 0, 0, .75)), url(public/assets/images/logos/about-1.jpg) center center no-repeat;
...
.form-control::file-selector-button {
    padding: .375rem .75rem;
    margin: -.375rem -.75rem;
    margin-inline-end:.75rem;color: #757575;
    background-color: #e9ecef;
    pointer-events: none;
    border-color: inherit;
    border-style: solid;
...
.text-primary[data-v-d9f37526] {
    color: #F3BD00!important;
}
.py-6 {
    padding-top: 6rem;
    padding-bottom: 6rem;
}.py-6[data-v-d9f37526] {
    padding-top: 6rem;
    padding-bottom: 6rem;
}
.display-6[data-v-d9f37526] {
    font-size: calc(1.375rem + 1.5vw);
    font-weight: 700;
    line-height: 1.2;
    margin-top: 100px;
