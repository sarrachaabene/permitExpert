            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('api/user/store') }}">
                        ...
                        <div class="row mb-3">
                            <label for="numTel" class="col-md-4 col-form-label text-md-end">{{ __('Numéro de Téléphone') }}</label>

                            <div class="col-md-6">
                                <input id="numTel" type="text" class="form-control @error('numTel') is-invalid @enderror" name="numTel" value="{{ old('numTel') }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="dateNaissance" type="date" class="form-control @error('dateNaissance') is-invalid @enderror" name="dateNaissance" value="{{ old('dateNaissance') }}" required>
